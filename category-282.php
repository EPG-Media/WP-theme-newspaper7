...
<!--------------------------------------------------------------- -->
				<div style="max-width: 1068px; text-align: center; align-items: center; margin: 0 auto;"
>
                <img class="aligncenter size-full wp-image-25131" title="greatroadswebbanner" src="" alt="" width="1078" height="200" />
				<p style="text-align: center;">Our touring features are organized by region. Just click on the map below to find articles about that region, or click <a href="http://ridermagazine.com/great-roads-by-region/"><strong>HERE</strong></a> to see articles by state.</p>
				<?php 
				echo do_shortcode('
				[kml_flashembed publishmethod="static" fversion="8.0.0" movie="/wp-content/uploads/2012/11/Great-Roads-Map.swf" width="600" height="390" targetclass="flashmovie"]
				...
				');?>
				<p style="text-align: center;"><strong>Can't use our interactive map? Rather see stories by state? <a href="http://www.ridermagazine.com/great-roads-by-region">Browse here</a>!</strong></p>
